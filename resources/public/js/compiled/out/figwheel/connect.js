...
goog.require('clojure_workshop.core');
...
var G__30102__delegate = function (x){
if(cljs.core.truth_(clojure_workshop.core.mount_root)){
return cljs.core.apply.call(null,clojure_workshop.core.mount_root,x);
} else {
return figwheel.client.utils.log.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),"Figwheel: :on-jsload hook 'clojure-workshop.core/mount-root' is missing");
}
};
...
while (G__30103__i < G__30103__a.length) {G__30103__a[G__30103__i] = arguments[G__30103__i + 0]; ++G__30103__i;}
  x = new cljs.core.IndexedSeq(G__30103__a,0);
} 
return G__30102__delegate.call(this,x);};
G__30102.cljs$lang$maxFixedArity = 0;
G__30102.cljs$lang$applyTo = (function (arglist__30104){
var x = cljs.core.seq(arglist__30104);
return G__30102__delegate(x);
});
...
//# sourceMappingURL=connect.js.map?rel=1446451742514